...
train_entries = pickle.load(open('/home/jungjunkim/xlmert_feat/VQA_ref_testdataset.pkl', 'rb'))
...
train_iid2id = pickle.load(open('/home/jungjunkim/generate_captions_for_vqa-master/data/test36_imgid2idx.pkl', 'rb'))
...
cxt_features = h5py.File('/home/jungjunkim/generate_captions_for_vqa-master/data/test36.hdf5', 'r')
...
def eval_all(params):
    ...
    with h5py.File('new_hdf5/add_test36.hdf5', 'w') as hf:
        hf.create_dataset('image_features', data=all_image_feats, maxshape=(82783, 36, 2048))
        hf.create_dataset('spatial_features', data=all_sp_feats, maxshape=(82783, 36, 6))
        hf.create_dataset('image_bb', data=all_boxes, maxshape=(82783, 36, 4))
        hf.create_dataset('additional_feats', data=add_feats, maxshape=(82783, 36, 1024))
