...
class DataLoader:
    ...
    def fetch_feats(self, batch_ann_ids, expand_size, opt):
        ...
        df, dlf = self.fetch_dif_feats(batch_ann_ids, expand_size, image_id, opt)
    ...
    def fetch_my_neighbour(self, target_box, image_id):
        ...
        features36 = all_features[idx]
        boxes36 = all_boxes[idx]
    ...
    def fetch_dif_feats(self, batch_ann_id, expand_size, image_id, opt):
        ...
        for i, ann_id in enumerate(batch_ann_id):
            ...
            cand_ann_feats, neighbour_boxes = self.fetch_my_neighbour(self.Anns[ann_id]['box'], image_id)
            # st_ann_ids = st_ann_ids[:3]
            # if len(st_ann_ids)==0:
            #     continue
            ...
            for neighbor_box in neighbour_boxes:
                neighbor_box[2] -= neighbor_box[0]
                neighbor_box[3] -= neighbor_box[1]
                cbox = neighbor_box
    ...
    def getBatch(self, split, opt):
        ...
        rank = []
        # import pickle
        # pickle.dump(self.Anns, open('/home/jungjunkim/xlmert_feat/anns.pkl', 'wb'), protocol=2)
